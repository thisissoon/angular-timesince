...
### Clone the Angular TimeSince repository

Clone the angular-timesince repository using [git][git]:

```
cd path/to/parent/directory
git clone git@github.com:thisissoon/angular-timesince.git
cd angular-timesince
```
